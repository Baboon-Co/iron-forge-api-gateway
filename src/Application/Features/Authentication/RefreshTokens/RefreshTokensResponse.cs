...
namespace Application.Features.Authentication.RefreshTokens;

[SwaggerSchemaFilter(typeof(RefreshTokensResponseSchemaFilter))]
...
internal class RefreshTokensResponseSchemaFilter : ISchemaFilter
{
